...
const principles = [
  ...
  },
  {
    number: '03',
    title: '年度情報には鮮度がある',
    body: '日程、料金、試験方式、制度は改定されます。制度確認日を明示し、確認から270日を超えた資格は自動で「開催要確認」へ降格します。申込前には必ず公式の最新案内を確認してください。',
  },
  {
    number: '04',
  ...
  },
  {
    number: '06',
    title: '「今も受けられるか」を分ける',
    body: '現行資格、開催状況を再確認すべき資格、終了済み資格を同列に扱いません。通常検索は現行資格を対象とし、開催要確認ページはサイト内参照用に残しつつ検索エンジンではnoindexとします。',
  },
];
