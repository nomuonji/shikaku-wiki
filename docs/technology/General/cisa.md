...
CISAは、ISACAが運営する**情報システム監査・統制・保証**分野の国際認定資格です。IT監査人だけでなく、IT統制、リスク、セキュリティ、ガバナンスに関わる実務家が、情報システムをリスクベースで評価するための知識を確認します。
...
CISA認定には、原則として**5年以上の情報システム監査・統制・セキュリティ関連の専門実務経験**が必要です。
...
- [CISA 公式ページ（ISACA）](https://www.isaca.org/credentialing/cisa)
- [CISA認定要件](https://www.isaca.org/credentialing/cisa/get-cisa-certified)
